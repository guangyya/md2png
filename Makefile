...
verify-dist: app
	...
	test "$$(/usr/libexec/PlistBuddy -c 'Print :NSServices:0:NSMenuItem:default' "$(CONTENTS)/Info.plist")" = "Preview with md2png"
	test "$$(/usr/libexec/PlistBuddy -c 'Print :NSServices:0:NSMessage' "$(CONTENTS)/Info.plist")" = "previewWithMd2png"
	test "$$(/usr/libexec/PlistBuddy -c 'Print :NSServices:0:NSRequiredContext:NSTextContent' "$(CONTENTS)/Info.plist")" = "FilePath"
	test "$$(/usr/libexec/PlistBuddy -c 'Print :NSServices:0:NSSendTypes:0' "$(CONTENTS)/Info.plist")" = "NSFilenamesPboardType"
